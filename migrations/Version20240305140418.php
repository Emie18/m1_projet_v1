 ...
 */
final class Version20240305140418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, tuteur_isen_id INT DEFAULT NULL, tuteur_stage_id INT DEFAULT NULL, apprenant_id INT DEFAULT NULL, entreprise_id INT DEFAULT NULL, groupe_id INT DEFAULT NULL, soutenance_id INT DEFAULT NULL, eval_entreprise_id INT DEFAULT NULL, rapport_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, commentaire VARCHAR(255) DEFAULT NULL, num_stage INT NOT NULL, date_soutenance DATETIME DEFAULT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, INDEX IDX_C27C936941EC5C6C (tuteur_isen_id), INDEX IDX_C27C9369681B4743 (tuteur_stage_id), INDEX IDX_C27C9369C5697D6D (apprenant_id), INDEX IDX_C27C9369A4AEAFEA (entreprise_id), INDEX IDX_C27C93697A45358C (groupe_id), INDEX IDX_C27C9369A59B3775 (soutenance_id), INDEX IDX_C27C9369ED0D7993 (eval_entreprise_id), INDEX IDX_C27C93691DFBCC46 (rapport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
