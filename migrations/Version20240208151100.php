 ...
 */
final class Version20240208151100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entreprise (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, adresse VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, tuteur_isen_id INT DEFAULT NULL, tuteur_stage_id INT DEFAULT NULL, apprenant_id INT DEFAULT NULL, entreprise_id INT DEFAULT NULL, groupe_id INT DEFAULT NULL, soutenance_id INT DEFAULT NULL, eval_entreprise_id INT DEFAULT NULL, rapport_id INT DEFAULT NULL, num_stage INT NOT NULL, titre VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, description VARCHAR(255) NOT NULL, commentaire VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_C27C936941EC5C6C (tuteur_isen_id), UNIQUE INDEX UNIQ_C27C9369681B4743 (tuteur_stage_id), UNIQUE INDEX UNIQ_C27C9369C5697D6D (apprenant_id), UNIQUE INDEX UNIQ_C27C9369A4AEAFEA (entreprise_id), UNIQUE INDEX UNIQ_C27C93697A45358C (groupe_id), UNIQUE INDEX UNIQ_C27C9369A59B3775 (soutenance_id), UNIQUE INDEX UNIQ_C27C9369ED0D7993 (eval_entreprise_id), UNIQUE INDEX UNIQ_C27C93691DFBCC46 (rapport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
